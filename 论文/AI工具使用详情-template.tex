...
%
% 排版:声明风格——用粗体段落标题(无 \section* / \subsection*),
%       整份文档像"参赛队填写的正式声明",不进入文章章节结构。
...
% ===== 标题(声明头) =====
\begin{center}
{\song\bfseries\zihao{2} AI 工具使用详情}
\end{center}

\vspace{1em}

% ========== 一、所使用的 AI 工具 ==========
\noindent\textbf{一、所使用的 AI 工具}
...
% ========== 三、主要提示方式与使用过程 ==========
\noindent\textbf{三、主要提示方式与使用过程}

按时间顺序记录每次关键交互(\textbf{典型 3-5 个示例即可,每例 $\le$ 200 字}):

\vspace{0.5em}
\noindent\textbf{示例 1:问题 X 第 Y 步}
...
\noindent\textbf{四、对 AI 输出的采纳、人工修改和核验情况}
...
{\song 本参赛队确认上述内容真实、准确,并承诺对 AI 参与完成的内容已逐项人工审查与核实。}
...
\noindent\textbf{(2) 关于参赛队责任} \quad 依据《全国大学生数学建模竞赛参赛规则》(2026 修订稿) 第 6 条,本参赛队对所提交作品的\textbf{原创性、真实性和准确性负全部责任}。
